...
from tensorflow.keras.layers import Conv2D, Conv2DTranspose, MaxPooling2D, LeakyReLU, Softmax
...
def unet(dropout, batch_norm):
    ...
    with tf.name_scope('Output'):
        up = Conv2D(32, kernel_size=3, activation=LeakyReLU(), padding=padding)(up)
        up = Conv2D(32, kernel_size=1, activation=LeakyReLU(), padding=padding)(up)
