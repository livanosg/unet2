...
def unet(args):
    ...
    down, connection_1 = down_block(img_inputs, 32, dropout=args.dropout, batch_norm=args.no_bn, padding=padding)
    down, connection_2 = down_block(down, 64, dropout=args.dropout, batch_norm=args.no_bn, padding=padding)
    down, connection_3 = down_block(down, 128, dropout=args.dropout, batch_norm=args.no_bn, padding=padding)
    down, connection_4 =down_block(down, 256, dropout=args.dropout, batch_norm=args.no_bn, padding=padding)
    bridge = double_conv(inputs=down, filters=1024, dropout=args.dropout, batch_norm=args.no_bn, padding=padding)
